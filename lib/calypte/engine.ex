defmodule Calypte.Engine do
  ...
  @callback add_exec_change(state, Changeset.t(), Binding.t()) :: state
  ...
  def add_exec_change(module, state, changeset, binding),
    do: module.add_exec_change(state, changeset, binding)
end
